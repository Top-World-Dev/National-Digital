  ...
  <div class="map-search">
    <div class="map-search-form">
      <div class="map-search-row">
        <input type="text" name="search" placeholder="Search" class="map-search-input" aria-label="search" v-model="searchValue" @keyup="search($event.target.value)" @keyup.enter="loadResults">
